...
-- 2. head_texture_updated_at: A TEXT field to store the timestamp of when the head texture was last updated.

ALTER TABLE users ADD COLUMN head_texture TEXT;
ALTER TABLE users ADD COLUMN head_texture_updated_at TEXT;